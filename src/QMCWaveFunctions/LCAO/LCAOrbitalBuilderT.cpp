...
template<>
std::unique_ptr<SPOSetT<float>> LCAOrbitalBuilderT<float>::createSPOSetFromXML(xmlNodePtr cur)
{
  ...
  {
    auto lcos = std::make_unique<LCAOrbitalSetT<float>>(spo_name, std::move(myBasisSet));
    loadMO(*lcos, cur);
...
template<>
std::unique_ptr<SPOSetT<double>> LCAOrbitalBuilderT<double>::createSPOSetFromXML(xmlNodePtr cur)
{
  ReportEngine PRE(this->ClassName, "createSPO(xmlNodePtr)");
  std::string spo_name(""), cusp_file(""), optimize("no");
  std::string basisset_name("LCAOBSet");
  ...
  {
    auto lcos = std::make_unique<LCAOrbitalSetT<double>>(spo_name, std::move(myBasisSet));
    loadMO(*lcos, cur);
    sposet = std::move(lcos);
  }
...
template<>
std::unique_ptr<SPOSetT<std::complex<float>>> LCAOrbitalBuilderT<std::complex<float>>::createSPOSetFromXML(
    xmlNodePtr cur)
{
  ReportEngine PRE(this->ClassName, "createSPO(xmlNodePtr)");
  std::string spo_name(""), cusp_file(""), optimize("no");
  ...
  {
    auto lcos = std::make_unique<LCAOrbitalSetT<std::complex<float>>>(spo_name, std::move(myBasisSet));
    loadMO(*lcos, cur);
    sposet = std::move(lcos);
  }
  return sposet;
...
template<>
std::unique_ptr<SPOSetT<std::complex<double>>> LCAOrbitalBuilderT<std::complex<double>>::createSPOSetFromXML(
    xmlNodePtr cur)
{
  ReportEngine PRE(this->ClassName, "createSPO(xmlNodePtr)");
  std::string spo_name(""), cusp_file(""), optimize("no");
  ...
  {
    auto lcos = std::make_unique<LCAOrbitalSetT<std::complex<double>>>(spo_name, std::move(myBasisSet));
    loadMO(*lcos, cur);
    sposet = std::move(lcos);
  }
  return sposet;
