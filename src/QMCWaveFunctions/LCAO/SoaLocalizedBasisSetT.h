...
class SoaLocalizedBasisSetT : public SoaBasisSetBase<ORBT>
{
public:
  using RealType  = typename COT::RealType;
  using BaseType  = SoaBasisSetBase<ORBT>;
  using ValueType = typename SoaBasisSetBase<ORBT>::value_type;
   ...
   */
  SoaLocalizedBasisSetT(ParticleSet& ions, ParticleSet& els);
