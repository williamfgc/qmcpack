...
template<typename T>
void CompositeSPOSetT<T>::evaluateValue(const ParticleSet& P, int iat, ValueVector& psi)
{
  int n = 0;
...
template<typename T>
void CompositeSPOSetT<T>::evaluateVGL(const ParticleSet& P,
                                      int iat,
                                      ValueVector& psi,
                                      GradVector& dpsi,
                                      ValueVector& d2psi)
...
template<typename T>
void CompositeSPOSetT<T>::evaluate_notranspose(const ParticleSet& P,
                                               int first,
                                               int last,
                                               ValueMatrix& logdet,
                                               GradMatrix& dlogdet,
